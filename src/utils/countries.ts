...
export const COUNTRIES_LIST: Country[] = [
  ...
  { name: 'East Timor', code: 'TL', flag: '🇹🇱', dialCode: '670' },
  ...
  { name: 'Saint Kitts & Nevis', code: 'KN', flag: '🇰🇳', dialCode: '1869' },
  ...
  { name: 'Trinidad & Tobago', code: 'TT', flag: '🇹🇹', dialCode: '1868' },
  ...
  { name: 'Wallis & Futuna', code: 'WF', flag: '🇼🇫', dialCode: '681' },
